...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/sharatrobinreddy/BlinkingLabel'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'sharatrobinreddy' => 'Sharat-robin-red.guduru@kp.org' }
  s.source           = { :git => 'https://github.com/sharatrobinreddy/BlinkingLabel.git', :tag => s.version.to_s }
